...
<!--  Edit modal -->
<div id="edit-modal-{{ $post->id }}" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            ...
            <form class="p-4 md:p-5" action="{{ route('post.update', $post->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2">
                        ...
                        <select id="train_station" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" name="train_station">
                            @foreach ($train_stations as $train_sation)
                                <option @if ($post->train_station_id == $train_sation->id) selected @endif value="{{ $train_sation->id }}" value="{{ $train_sation->id }}">{{$train_sation->name}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="description" rows="4" name="content" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Escribe una descripcion">{{ $post->content }}</textarea>
